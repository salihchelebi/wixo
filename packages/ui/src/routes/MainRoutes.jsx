...
const MainRoutes = {
    ...
    children: [
        {
            path: '/',
            // Bu koşul Netlify hafif prototip modunda kök yolu yalnızca landing deneyimine güvenli biçimde yönlendirir.
            element: import.meta.env.VITE_NETLIFY_LITE === 'true' ? <Navigate to='/netlify-lite' replace /> : <DefaultRedirect />
        },
        {
